...
if [[ -f "$CONFIG_FILE" ]]; then
  helm upgrade trendmicro --namespace trendmicro-system --values $HOME/CS_DEMO/overrides.yaml https://github.com/trendmicro/cloudone-container-security-helm/archive/master.tar.gz
